...
static void gzm_hook(precomp_instr *instr, _Bool recomp)
{
  void (*hook_func)(void);

  switch (instr->addr) {
#if Z64_VERSION == Z64_OOT10
    case 0x800A16B4 : hook_func = input_hook;     break;
    case 0x8009AC80 : hook_func = seed_hook;      break;
    case 0x800C1F78 : hook_func = oca_input_hook; break;
    case 0x800C2ED0 : hook_func = oca_sync_hook;  break;
    case 0x80080BD8 : hook_func = room_load_hook; break;
#elif Z64_VERSION == Z64_OOT11
    case 0x800A16BC : hook_func = input_hook;     break;
    case 0x8009AC90 : hook_func = seed_hook;      break;
    case 0x800C1FC8 : hook_func = oca_input_hook; break;
    case 0x800C2F2C : hook_func = oca_sync_hook;  break;
    case 0x80080BD8 : hook_func = room_load_hook; break;
#endif
    default         : hook_func = NULL;           break;
  }
  ...
  if (recomp) {
    ...
    mov_reg32_imm32(EAX, (unsigned long)hook_func);
    call_reg32(EAX);
...
void gzm_recomp_hook(precomp_instr *instr)
{
  gzm_hook(instr, 1);
}

void gzm_interp_hook(precomp_instr *instr)
{
  gzm_hook(instr, 0);
}
